...
def create_cmd_parser(prog=None):
    ...
    general_control.add_argument('--vla-model', action='store', type=str, dest='vla_model', default=None, help='OpenVLA model ID or path (default: mock)')
    ...
    general_control.add_argument('--vla-goal-scale', action='store', type=float, dest='vla_goal_scale', default=1.0, help='Multiply goal features in DDIM (test only, >1 pushes toward goal)')
